        ...
        filter: {
          condition:  function(searchTerm, cellValue) {
              ...
              for(iIndex in strippedValue){
                  ...
                  console.log("striped valu" + strippedValue + " searchTerm " + searchTerm +" cellValue " + cellValue + "sValueToTest" + sValueToTest + " cellValueto lower case " + cellValue.toLowerCase().indexOf(sValueToTest.toLowerCase()));
           ...
           /*
            for (i = 0; i < strippedValue.length; i++){
              strippedValue[i] = strippedValue[i].replace(" ", "");
              if (cellValue.indexOf(strippedValue[i]) >= 0)
                bReturnValue = true;
            }
            */
            return bReturnValue;
